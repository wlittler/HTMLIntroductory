...
* Have you index.html
* Have a css and ing folder - if the folder is empty it wont sync so dont worry if you dont see a folder yet.
...
**Commint to those changes and make sure everything is linked correctly.**
